...
% [todo] - write about terminology, guarantees and so on that correspond between Wedelin08's language and that of Allouche/Givry/Schiex
% 
% Arc consistency: (Wedelin08, p.8) corresponds to what kind of consistency? How does EDAC* relate to this? (deGivry05) How does soft arc consistency relate? (Cooper10)
% http://en.wikipedia.org/wiki/Local_consistency#Arc_consistency implies that we have normal AC*, with in-the-middle being a simplistic algorithm
% But what would EDAC be in our case?
% 
