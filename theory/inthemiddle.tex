...
% [review] - previous utility in industry? (is in introduction already)
...
% [review] - mention tie-breaking with random offsets?
...
% [review] - formula terminology above unclear?
...
% 
% Arc consistency: (Wedelin08, p.8) corresponds to what kind of consistency? How does EDAC* relate to this? (deGivry05)
