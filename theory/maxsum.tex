...
Problems including set partitioning \parencite[\pno~107]{Wedelin08}, max-flow/min-cut and (as will be apparent later) several variants of constraint satisfaction may be restated as max-sum problems.
Formally, the following definition (which is based on that of \citeauthor{Wedelin08}) may be used:
...
% [review] - theory on upper/lower bounds?
...
% [todo] - mention previous algorithms from the AI field?
...
% [review] - theory on upper/lower bounds?
% [review] - mention previous algorithms and results?
...
% [review] - mention previous algorithms?
