...
The greedy \gls{dp} update, obtained by fixing \(\alpha=1\) of the fractional \gls{dp} update, should theoretically improve convergence at the expense of the optimality guarantee.
...
\Cref{tab:greedy-dp-results} shows the results of benchmarking the greedy \gls{dp} algorithm against the selected problems.
...
\Cref{fig:cactus-greedy} illustrates the utility of the greedy \gls{dp} update.
