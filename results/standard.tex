...
\Cref{fig:cactus-std:dbn} highlight a more interesting situation.
...
% [todo] - relate back to presentation of problems, especially the table of values of everything
...
% Relevant measure?: n*d "size" of problem

% [todo] - relate to pp. 5-6 of deGivry14
% [review] - discuss specific problem instances (largest solved)?
% 
% [todo] - discuss the fact that CPLEX and MaxHS are LP solvers, and that the LP formulation of ITM might be competitive in the same areas due to problem structure
...
\begin{figure}[tp]
	...
	%\\
	%\begin{figcenter}
	%\subfloat[The \emph{Black Hole} set of the Max-\gls{csp} category.\label{fig:cactus-std:blackhole}]{\input{figs/cactus-MaxCSP-BlackHole.tikz}}
	%\end{figcenter}
