...
% * stating parameters used (maybe before this section)
% * analyzing interesting problem sets
% * comparing with other solvers
% * identify what problems ITM is good at

% Interesting cactus plots: CP/ParityLearning, CVPR/GeomSurf, MaxCSP/{BlackHole,Geometric,QCP}, MRF/{DBN,ObjectDetection,Segmentation}
...
\begin{table}
	...
	\caption{
		...
		Some problem sets have been omitted. % [todo] - omitted data sets should be removed from the presentation and mentioned in the beginning of that section as omitted.
	}
