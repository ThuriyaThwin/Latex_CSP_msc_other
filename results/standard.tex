...
\Cref{fig:cactus-std} shows accumulated runtimes for two of the sets in which the algorithm performed well.
...
The smallest unsolved instances are in the \emph{Auction} set, with search spaces \(d^n \approx 2^{80}\).
