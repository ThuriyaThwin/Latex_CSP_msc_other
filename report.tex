...
\SetupMetadata{
	...
	abstract = {%
		The field of graphical modelling has been very active in recent years, which is unsurprising given the large range of problems which may be described using graphical model.
		...
		The in-the-middle algorithm, an approximate solution method in linear programming which has seen extensive use in the industry, has recently been extended to max-sum problems.
