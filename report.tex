...
\SetupMetadata{
	...
	title = {Evaluating the in-the-middle heuristic in Graphical Model Discrete Optimization},
...
\begin{document}
	...
	% [todo] - check grammatical tense, grammatical person, etc. (check writing guide)
	% [fix] - use "I" for first-person
	% [todo] - check overall conformance to writing guide
	...
	% [review] - do we need a separate discussion?
	% [todo] - things like combining linear constraints with cost functions haven't been tested, need to mention that _somewhere_

	\chapter{Conclusions}
	\input{conclusions.tex}

	% [todo] - should the glossary be here?
