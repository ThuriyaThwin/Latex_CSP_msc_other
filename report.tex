...
\SetupMetadata{
	...
	keywords = {combinatorial optimization,linear programming,max-sum,constraint programming,constraint satisfaction,CSP,weighted CSP,WCSP,constraint function network,CFN,markov random field,MRF,?},
	abstract = {?},
	% Optional metadata
	%issn = {},
	%subtitle = {},
